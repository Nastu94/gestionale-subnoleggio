{{-- resources/views/livewire/locations/form.blade.php --}}

<div class="p-4">
    <form wire:submit.prevent="save" class="space-y-6">
        <div>
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3">
                {{ $isEdit ? 'Modifica dati sede' : 'Dati sede' }}
            </h3>
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            <a href="{{ $isEdit ? route('locations.show', $location) : route('locations.index') }}"
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-1"></i> {{ $isEdit ? 'Salva modifiche' : 'Crea sede' }}
            </button>
        </div>
    </form>
</div>
